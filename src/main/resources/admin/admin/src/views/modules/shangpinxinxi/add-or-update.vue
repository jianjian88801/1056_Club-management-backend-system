<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="商品ID" prop="shangpinID">
            <el-input v-model="ruleForm.shangpinID" 
                placeholder="商品ID" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangpinID" label="商品ID" prop="shangpinID">
              <el-input v-model="ruleForm.shangpinID" 
                placeholder="商品ID" readonly></el-input>
          </el-form-item>
        </div>
